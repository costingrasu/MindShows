...
function journey_theme_scripts() {
  ...
  elseif (is_singular('development')) {
      ...
      wp_enqueue_script('development-js', get_template_directory_uri() . '/assets/js/development.js', array(), '2.6.0', true);
  ...
  elseif (is_page_template('development.php')) {
      wp_enqueue_style('theme-development-page', get_template_directory_uri() . '/assets/css/development.css', array('mindshows-style'), '2.6.0');
      wp_enqueue_script('development-js', get_template_directory_uri() . '/assets/js/development.js', array(), '2.6.0', true);
  }
  elseif (is_page()) {
